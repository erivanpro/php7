...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr">
  ...
  <body>
    ...
    echo 'Il y a ',count($auteurs),' auteurs dans la liste.<br />';
    // Afficher mon auteur préféré (aléatoire).
    $mon_auteur = $auteurs[rand(0,count($auteurs)-1)];
    $mon_auteur = preg_replace('/(.*) (.*)/','$2 ($1)',$mon_auteur);
    echo $mon_auteur,' est mon auteur préféré.<br />';
    ?>
